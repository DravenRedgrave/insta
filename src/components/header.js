...
export default function Header(){
    ...
    return <header className="h-16 bg-white boreder-b border-gray-primary mb-8">
        <div className="container mx-auto max-w-screen-lg h-full">
          <div className="flex justify-between h-full">
              <div className="text-gray-700 text-center flex items-center align-items curor-pointer">
              ...
              <div className="text-gray-700 text-center flex items-center align-items">
                ...
                <button type="button"
                title="Sign out" onClick={()=>firebase.auth.signOut()} onKeyDown={(event) => {
                  if (event.key ==='Enter'){
